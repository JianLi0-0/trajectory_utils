    ...
    namespace common {
        namespace math {
            ...
            PathPoint InterpolateUsingLinearApproximation(const PathPoint &p0,
                ...
                double xt = (1 - weight) * p0.x_t() + weight * p1.x_t();
                double yt = (1 - weight) * p0.y_t() + weight * p1.y_t();
                double theta1 = slerp(p0.theta1(), p0.s(), p1.theta1(), p1.s(), s);
                ...
                path_point.set_x_t(xt);
                path_point.set_y_t(yt);
                path_point.set_theta1(theta1);
